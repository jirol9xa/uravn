...
void input(struct Coefficients*); // дл€ ввода данных
void eatline(); // дл€ отбрасывани€ отсальной части строки, если данные будут введены с мусором
void wrong_input(); // на случай неправильного ввода
void solve_equation(struct Answers* ans, struct Coefficients* Coef); // решение уравнени€
